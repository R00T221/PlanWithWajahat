// Creating a component 'data.js' which includes all data related to cards.  
...
const data = [
...

	{
        id: 8,
		name: "Kashmir",
		info: `"Kashmir, often referred to as '/"Paradise on Earth," is renowned for its breathtaking beauty and serene landscapes. Nestled in the northern part of India, this region boasts snow-capped mountains, verdant valleys, and crystal-clear lakes. The Dal Lake, with its iconic houseboats and shikaras, offers a picturesque and tranquil experience. "`,
		image: "https://static.toiimg.com/photo/msid-91918900,width-96,height-65.cms",
		price: "87,595",
